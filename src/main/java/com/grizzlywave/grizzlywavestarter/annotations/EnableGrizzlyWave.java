...
import com.grizzlywave.grizzlywavestarter.controller.WaveController;
...
@Import({ AnnotationAspect.class, KafkaConfig.class, KafkaTopicConfiguration.class, WaveConfigProperties.class,
		TopicServices.class, WaveTopicBeanPostProcessor.class,WaveController.class,WaveBpmnPostProcessor.class })
